...
public static class SiteTextKeys
{
    ...
    public static string GetDefault(string key)
    {
        return key switch
        {
            ...
            SectionHakkimizdaSubtitle => "İdeal Denge Akademi, kişisel ve mesleki gelişim için tasarlanmış bir online eğitim platformudur. Alanında uzman eğitmenlerimizle hazırlanan video, PDF ve makalelerle kendinize yeni yetkinlikler kazandırın.",
            ...
            FooterCopyright => "© {0} İdeal Denge Akademi (www.idealdengeakademi.com). Tüm hakları saklıdır.",
            MetaDescriptionDefault => "İdeal Denge Akademi ile online eğitimlere katılın. Video, PDF ve makalelerle kişisel ve mesleki gelişim.",
            HakkimizdaBreadcrumbSubtitle => "İdeal Denge Akademi olarak nereden geldiğimiz, neye inandığımız ve sizin için neler sunduğumuz.",
